...
# analysing image and extracting text for OCR 
...
def insert_license_plate_to_db(license_plate_text):
    ...
    if conn:
        try:
            ...
            toll_booth_id = 45
            query = "INSERT INTO OCRDetails (toll_booth_id, license_plate_text) VALUES (?,?)"
            cursor.execute(query, (toll_booth_id, license_plate_text,))
            conn.commit()
...
def perform_ocr(image_path):
    ...
    try:
        ...
        if result.status == OperationStatusCodes.succeeded:
            ...
            return  "".join(license_plate_text)
    except Exception as e:
...
def main():
    ...
    # Image details
    blob_name = "Cars14.png"
    local_image_path = r"D:\PYTHON_ML\Data Sets\images\Cars97.png"
